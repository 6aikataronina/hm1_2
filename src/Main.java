public class Main {
    public static void main(String[] args) {
        ...
        Voleyball voleyball = new Voleyball(TypeOfSport.GROUND,stadium,12,20,"Milana");
        ...
        Pioneerball pioneerball1= new Pioneerball(TypeOfSport.GROUND,stadium2,12,22,"Daki",2);
